...
public class PedidosPendientes_Client {
    String uuid;
    String uuid_Cliente;
    String FechaVenta;
    String HoraVenta;
    ...
    public PedidosPendientes_Client(String Item_uuid, String Item_uuid_Cliente, String Item_FechaVenta, String Item_HoraVenta, Float Item_SubTotal, String Item_Pendiente, String Item_UUID_Producto, Float Item_PrecioProducto, int Item_CantidadProducto,
    ...
    public static List<PedidosPendientes_Client> obtenerPedidosPendientes(Connection connection, String UUID) {
        List<PedidosPendientes_Client> pedidosPendientes = new ArrayList<>();
        String query = "SELECT " +
                ...
                "WHERE p.Pedido_Pendiente = 'Si' AND p.UUID_Cliente = ?";
        ...
        try (ResultSet resultSet = preparedStatement.executeQuery()) {
            while (resultSet.next()) {
                PedidosPendientes_Client pedido = new PedidosPendientes_Client(
