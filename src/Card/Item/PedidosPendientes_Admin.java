...
public class PedidosPendientes_Admin {
    String uuid;
    String uuid_Cliente;
    String FechaVenta;
    String HoraVenta;
    ...
    public PedidosPendientes_Admin(String Item_uuid, String Item_uuid_Cliente, String Item_FechaVenta, String Item_HoraVenta, Float Item_SubTotal, String Item_Pendiente, String Item_UUID_Producto, Float Item_PrecioProducto, int Item_CantidadProducto,
    ...
    public static List<PedidosPendientes_Admin> obtenerPedidosPendientes(Connection connection) {
        List<PedidosPendientes_Admin> pedidosPendientes = new ArrayList<>();
        String query = "SELECT " +
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(query);
            ...
            while (resultSet.next()) {
                PedidosPendientes_Admin pedido = new PedidosPendientes_Admin(
