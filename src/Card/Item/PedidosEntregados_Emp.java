...
public class PedidosEntregados_Emp {
    String uuid;
    String uuid_Cliente;
    String FechaVenta;
    String HoraVenta;
    ...
    public PedidosEntregados_Emp(String Item_uuid, String Item_uuid_Cliente, String Item_FechaVenta, String Item_HoraVenta, Float Item_SubTotal, String Item_Pendiente, String Item_UUID_Producto, Float Item_PrecioProducto, int Item_CantidadProducto,
    ...
    public static List<PedidosEntregados_Emp> obtenerPedidosEntregados(Connection connection) {
        List<PedidosEntregados_Emp> pedidosEntregados = new ArrayList<>();
        String query = "SELECT " +
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(query);
            ...
            while (resultSet.next()) {
                PedidosEntregados_Emp pedido = new PedidosEntregados_Emp(
