...
public class PedidosPendientes_Emp {
    ...
    public PedidosPendientes_Emp(String Item_uuid, String Item_uuid_Cliente, String Item_FechaVenta, String Item_HoraVenta, Float Item_SubTotal, String Item_Pendiente, String Item_UUID_Producto, Float Item_PrecioProducto, int Item_CantidadProducto,
    ...
    public static List<PedidosPendientes_Emp> obtenerPedidosPendientes(Connection connection) {
        List<PedidosPendientes_Emp> pedidosPendientes = new ArrayList<>();
        String query = "SELECT " +
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(query);
            ...
            while (resultSet.next()) {
                PedidosPendientes_Emp pedido = new PedidosPendientes_Emp(
