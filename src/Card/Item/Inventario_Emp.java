...
public class Inventario_Emp {
    ...
    public Inventario_Emp(String Item_UUID_Producto, String Item_Img_Producto, String Item_Nombre_Producto, Float Item_Precio_Producto, int Item_Cantidad_Bodega, String Item_Categoria_Flores,
    ...
    public static List<Inventario_Emp> obtenerProductos(Connection connection) {
        List<Inventario_Emp> productos = new ArrayList<>();
        String query = "SELECT * FROM TbInventario";
        try (PreparedStatement preparedStatement = connection.prepareStatement(query);
             ResultSet resultSet = preparedStatement.executeQuery()) {

            while (resultSet.next()) {
                Inventario_Emp producto = new Inventario_Emp(
