...
public class Sales_Emp {
    ...
    public Sales_Emp(String Item_uuid, String Item_uuid_Empleado, String Item_FechaVenta, String Item_HoraVenta, String Item_NombreCliente,
    ...
    public static List<Sales_Emp> obtenerVentas(Connection connection) {
        List<Sales_Emp> Ventas = new ArrayList<>();
        String query = "SELECT " +
