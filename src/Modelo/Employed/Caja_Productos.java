...
public class Caja_Productos {
    ...
    public void setDescripcion(String descripcion) {
     ...
     public Caja_Productos(String Item_UUID_Producto, String Item_Img_Producto, String Item_Nombre_Producto, Float Item_Precio_Producto, int Item_Cantidad_Bodega, String Item_Categoria_Flores,
    ...
    public static List<Caja_Productos> obtenerProductos(Connection connection) {
        List<Caja_Productos> productos = new ArrayList<>();
        String query = "SELECT * FROM TbInventario";
        try (PreparedStatement preparedStatement = connection.prepareStatement(query);
             ResultSet resultSet = preparedStatement.executeQuery()) {

            while (resultSet.next()) {
                Caja_Productos producto = new Caja_Productos(
