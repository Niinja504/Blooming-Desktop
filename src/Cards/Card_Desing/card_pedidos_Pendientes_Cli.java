...
public class card_pedidos_Pendientes_Cli extends javax.swing.JPanel {

    private boolean selected;
    private PedidosPendientes_Client data;
    ...
    public card_pedidos_Pendientes_Cli(Ctrl_PedidosPendientes_client controlador) {
    ...
    public void setData(PedidosPendientes_Client data){
        this.data = data;
