...
public class card_pedidos_Entregados_Ad extends javax.swing.JPanel {
    ...
    public card_pedidos_Entregados_Ad(Ctrl_PedidosEntregados_admin controlador) {
    ...
    public PedidosEntregados_Admin getData() {
        return data;
    }
