...
public class card_sales_Emp extends javax.swing.JPanel {
    
    private boolean selected;
    private Sales_Emp data;
    ...
    public card_sales_Emp(Ctrl_Ventas_Emp controlador) {
    ...
    public void setData(Sales_Emp data){
        this.data = data;
