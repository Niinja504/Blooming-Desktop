...
public class card_pedidos_Pendientes_Emp extends javax.swing.JPanel {
    
    private boolean selected;
    private PedidosPendientes_Emp data;
    ...
    public card_pedidos_Pendientes_Emp(Ctrl_PedidosPendientes_Emp controlador) {
     this.controlador = controlador;
     initComponents();
     setOpaque(false);
   }

    public void setData(PedidosPendientes_Emp data){
        this.data = data;
