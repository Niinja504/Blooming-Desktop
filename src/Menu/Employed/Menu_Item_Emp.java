...
public class Menu_Item_Emp extends JButton {
    ...
    public Menu_Item_Emp(String name, int index, boolean subMenuAble) {
        super(name);
        this.index = index;
        this.subMenuAble = subMenuAble;
    ...
    private void createShadowImage() {
        ...
        shadow = new ShadowRender(shadowSize, 0.2f, Color.BLACK).createShadow(img);
        g2.dispose();
    }
