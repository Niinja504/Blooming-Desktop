...
import Cards.Card_Desing.card_pedidos_Pendientes_Cli;
import Cards.EventItemImpl_PedidosPe;
import Cards.EventItemImpl_PedidosPe_Cli;
...
public class Panel_Pedido_Pendiente_Cliente extends javax.swing.JPanel {

    private EventItem_PedidosPendientes_Cli event;
    private Ctrl_PedidosPendientes_client controlador;
    
    public Panel_Pedido_Pendiente_Cliente(Ctrl_PedidosPendientes_client controlador) {
        this.controlador = controlador;
        this.event = new EventItemImpl_PedidosPe_Cli();
        try {
    ...
    public void setControlador(Ctrl_PedidosPendientes_client controlador) {
       this.controlador = controlador;
    }

    public void addItem(PedidosPendientes_Client data) {
        card_pedidos_Pendientes_Cli item = new card_pedidos_Pendientes_Cli(controlador);
        item.setData(data);
        item.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent me) {
                if (SwingUtilities.isLeftMouseButton(me)) {
                    setSelected(item);
                    event.itemClick(item, data, Panel_Pedido_Pendiente_Cliente.this);
                }
            }
        });
        panelItem.add(item);
    ...
    public void setSelected(Component item){
        for (Component com : panelItem.getComponents()){
            card_pedidos_Pendientes_Cli i = (card_pedidos_Pendientes_Cli) com;
            if (i.isSelected()){
                i.setSelected(false);
            }
        }
        ((card_pedidos_Pendientes_Cli) item).setSelected(true);
    }
    
    public void ShowItem(PedidosPendientes_Client data){
    ...
    public void cargarPedidos(List<PedidosPendientes_Client> pedidos) {
       panelItem.removeAll(); 
       for (PedidosPendientes_Client pedido : pedidos) {
            addItem(pedido);
        }
       panelItem.revalidate(); 
       panelItem.repaint();
    ...
    public void setEvent(EventItem_PedidosPendientes_Cli event) {
        this.event = event;
    }
