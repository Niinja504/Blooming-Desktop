...
import Cards.Card_Desing.card_inventario_Emp;
import Cards.EventItemImpl_Inventario_Emp;
...
public class Panel_Inventario_Employed extends javax.swing.JPanel {
    
    private EventItem_Inventario_Emp event;
    private Ctrl_Inventario_Emp controlador;
    
    public Panel_Inventario_Employed(Ctrl_Inventario_Emp controlador) {
        this.controlador = controlador;
        this.event = new EventItemImpl_Inventario_Emp();
        try {
    ...
    public void setControlador(Ctrl_Inventario_Emp controlador) {
       this.controlador = controlador;
    }

    public void addItem(Inventario_Emp data) {
        card_inventario_Emp item = new card_inventario_Emp(controlador);
        item.setData(data);
        item.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent me) {
                if (SwingUtilities.isLeftMouseButton(me)) {
                    setSelected(item);
                    event.itemClick(item, data, Panel_Inventario_Employed.this);
                }
            }
        });
        panelItem.add(item);
    ...
    public void setSelected(Component item){
        for (Component com : panelItem.getComponents()){
            card_inventario_Emp i = (card_inventario_Emp) com;
            if (i.isSelected()){
                i.setSelected(false);
            }
        }
        ((card_inventario_Emp) item).setSelected(true);
    }
    
    public void ShowItem(Inventario_Emp data){
    ...
    public void cargarInventario(List<Inventario_Emp> productos) {
       panelItem.removeAll(); 
       for (Inventario_Emp Inventario : productos) {
            addItem(Inventario);
        }
       panelItem.revalidate(); 
       panelItem.repaint();
    ...
    public void setEvent(EventItem_Inventario_Emp event) {
        this.event = event;
    }
