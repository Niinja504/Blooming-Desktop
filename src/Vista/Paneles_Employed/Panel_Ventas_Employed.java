...
import Cards.Card_Desing.card_sales_Emp;
import Cards.EventItemImpl_Ventas_Emp;
...
public class Panel_Ventas_Employed extends javax.swing.JPanel {

    private EventItem_Ventas_Emp event;
    private Ctrl_Ventas_Emp controlador;
    
    public Panel_Ventas_Employed(Ctrl_Ventas_Emp controlador) {
        this.controlador = controlador;
        this.event = new EventItemImpl_Ventas_Emp();
        try {
    ...
    public void setControlador(Ctrl_Ventas_Emp controlador) {
        this.controlador = controlador;
    }
    
    public void addItem(Sales_Emp data) {
        card_sales_Emp item = new card_sales_Emp(controlador);
        item.setData(data);
        item.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent me) {
                if (SwingUtilities.isLeftMouseButton(me)) {
                    setSelected(item);
                    event.itemClick(item, data, Panel_Ventas_Employed.this);
                }
            }
        });
        panelItem.add(item);
    ...
    public void setSelected(Component item){
        for (Component com : panelItem.getComponents()){
            card_sales_Emp i = (card_sales_Emp) com;
            if (i.isSelected()){
                i.setSelected(false);
            }
        }
        ((card_sales_Emp) item).setSelected(true);
    }
    
    public void ShowItem(Sales_Emp data){
    ...
    public void cargarVentas(List<Sales_Emp> ventas) {
       panelItem.removeAll(); 
       for (Sales_Emp venta : ventas) {
            addItem(venta);
        }
       panelItem.revalidate(); 
       panelItem.repaint();
    ...
    public void setEvent(EventItem_Ventas_Emp event) {
        this.event = event;
    }
